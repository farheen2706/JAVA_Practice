...
public class VM
{
	public static void main(String[] args)throws IOException
	{
	    ...
	    do{
	        ...
	        System.out.println("2.Display an element");
	        System.out.println("3.Display size of an element");
	        ...
	        switch(cho)
	        {
	           ...
	           case 3:
	               ...
	               break;
	           case 4:
	               System.out.println("Display capacity");
	               System.out.println("The size of the vector:"+v.capacity());
	               break;
	           case 5:
